...
- [x] **4.2** (2026-09-03: `nightly.yml` self-hosted stub, hypothesis profiles `ci`=200/`nightly`=5000, fast-CI coverage gate 75 % (engine-free selection measures 81 %), `lattix validate --html`) Nightly: property fuzz (5000 examples), full corpus, `oracle_tracewin`; coverage gate; `lattix report` HTML (per-element error vs s).
