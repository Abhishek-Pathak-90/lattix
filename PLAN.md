...
- [x] **4.4** (2026-09-03: version 0.1.0, sdist + wheel built locally, tag v0.1.0; **no PyPI upload** by user decision; the GitHub repo was private under `Abhishek-Pathak-90` then, and is public at `Accel-Toolkit/lattix` since 2026-09-07) Release 0.1 to PyPI; license audit of `tests/data/public/`. Backlog (Tier 3): OPAL, DYNAC (reference `dynac/converters/tw2dyn.f`), Astra/GPT via Bmad converters, TRACK, PyORBIT3 linac XML.
